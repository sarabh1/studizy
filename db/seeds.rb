...
session_5 = Session.create!(course: course_3, name: "Dice Probabilities", start_date: DateTime.new(2022, 10, 12, 8, 30), end_date: DateTime.new(2022, 10, 12, 10, 30))
session_6 = Session.create!(course: course_3, name: "Loto game", start_date: DateTime.new(2022, 10, 13, 8, 00), end_date: DateTime.new(2022, 10, 13, 10, 00))
...
session_8 = Session.create!(course: course_4, name: "History of Thales", start_date: DateTime.new(2022, 10, 13, 14, 00), end_date: DateTime.new(2022, 10, 13, 16, 00))
session_9 = Session.create!(course: course_4, name: "TD : theory", start_date: DateTime.new(2022, 10, 10, 8, 00), end_date: DateTime.new(2022, 10, 10, 10, 00))
session_10 = Session.create!(course: course_3, name: "Casino games", start_date: DateTime.new(2022, 10, 14, 8, 00), end_date: DateTime.new(2022, 10, 14, 10, 00))
...
session_12 = Session.create!(course: course_1, name: "Calcul of surfaces", start_date: DateTime.new(2022, 10, 14, 14, 00), end_date: DateTime.new(2022, 10, 14, 17, 00))
...
session_16 = Session.create!(course: course_1, name: "Exam - Triangles", start_date: DateTime.new(2022, 10, 13, 16, 00), end_date: DateTime.new(2022, 10, 13, 16, 00))
...
session_25 = Session.create!(course: course_2, name: "Homework - Algebra", start_date: DateTime.new(2022, 10, 11, 14,00), end_date: DateTime.new(2022, 10, 11, 15, 00))
