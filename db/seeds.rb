...
session_1 = Session.create(course: course_1, name: "Pythagore theorem", start_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now), end_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now))
session_2 = Session.create(course: course_1, name: "Systems x + y", start_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now), end_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now))
session_3 = Session.create(course: course_2, name: "{A + B} + 2", start_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now), end_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now))
session_4 = Session.create(course: course_2, name: "ax + cy = d", start_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now), end_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now))
...
session_6 = Session.create(course: course_3, name: "Loto game", start_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now), end_date: Faker::Time.between(from: 2.days.ago, to: DateTime.now))
...
session_11 = Session.create(course: course_3, name: "Train running late", start_date: Faker::Time.between(from: Date.today + 1, to: Date.today + 2), end_date: Faker::Time.between(from: Date.today, to: Date.today + 6))
