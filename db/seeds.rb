...
session_1 = Session.create!(course: course_1, name: "Pythagore theorem", start_date: DateTime.new(2022, 9, 21, 8, 00), end_date: DateTime.new(2022, 9, 21, 10, 00))
...
session_11 = Session.create!(course: course_3, name: "Train running late", start_date: Faker::Time.between(from: Date.today, to: Date.today + 1), end_date: Faker::Time.between(from: Date.today + 1, to: Date.today + 3))
...
session_13 = Session.create!(course: course_4, name: "Contemporain profesors", start_date: Faker::Time.between(from: Date.today + 5, to: Date.today + 6), end_date: Faker::Time.between(from: Date.today + 5, to: Date.today + 6))
